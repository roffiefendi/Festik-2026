    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        <motion.div
          ...
          className="mb-16"
        >
          <span className="inline-block bg-gradient-cyan px-4 py-2 rounded-full text-xs uppercase tracking-[0.36em] text-cyan/80 font-medium">
            Gallery
          </span>
          <h2 className="mt-6 max-w-3xl font-serif text-5xl leading-tight text-cream sm:text-6xl">
            Cinematic festival visuals in layered frames.
          </h2>
        </motion.div>
          ...
          {items?.map((item, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                <p className="text-xs uppercase tracking-[0.28em] text-sage font-medium group-hover:text-cream transition-colors">
                  {item.caption || "Festival frame"}
                </p>
              </div>
            </motion.div>
          ))}
